...
class _GameScreenState extends State<GameScreen>
  ...
  List<Widget> _cornerOrnaments() {
    const size = 24.0;
    const pad = 16.0;
    final Widget ornament = SizedBox(
      width: size, height: size,
      child: CustomPaint(painter: _CornerPainter()),
    );

    return [
      Positioned(top: pad, left: pad, child: ornament),
      Positioned(top: pad, right: pad,
        child: Transform.rotate(angle: pi / 2, child: ornament)),
      Positioned(bottom: pad, left: pad,
        child: Transform.rotate(angle: -pi / 2, child: ornament)),
      Positioned(bottom: pad, right: pad,
        child: Transform.rotate(angle: pi, child: ornament)),
    ];
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: _P.goldGlow, blurRadius: 20, spreadRadius: 2),
          ],
        ),
        child: Text(
        ...
        children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              color: _P.gold, shape: BoxShape.circle,
            ),
          ),
          Text(
            '$_timerSeconds SEC TIMER',
            style: _T.label,
          ),
        ],
      ),
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              ...([5, 10, 15, 30]).map((sec) => _timerOption(sec)),
            ],
          ),
        );
      },
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: selected ? _P.gold : _P.muted.withOpacity(0.3),
          ),
        ),
        child: Row(
          children: [
            ...
            const Spacer(),
            if (selected)
              const Icon(Icons.check, color: _P.gold, size: 18),
          ],
        ),
      ),
    );
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                width: 36, height: 3,
                decoration: BoxDecoration(
                  color: _P.muted, borderRadius: BorderRadius.circular(2),
                ),
              ),
              Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: isCurrent
                            ? _P.gold.withOpacity(0.08)
                            : _P.card,
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: isCurrent
                              ? _P.gold.withOpacity(0.5)
                              : _P.muted.withOpacity(0.2),
                        ),
                      ),
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 12),
                          Expanded(
                            child: Text(card, style: const TextStyle(
                              color: _P.cream, fontFamily: 'Georgia', fontSize: 14, height: 1.4,
                            )),
                          ),
  ...
  PopupMenuItem<String> _menuItem(String value, IconData icon, String label, {Color color = _P.cream}) {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text('Choose a deck', style: const TextStyle(
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: selected ? _P.gold.withOpacity(0.5) : _P.muted.withOpacity(0.2),
                          ),
                        ),
                        child: Row(
                          children: [
    ...
    await showDialog(
      ...
      builder: (_) {
        return _inputDialog(
          ...
          multiline: true,
          onConfirm: (val) {
            if (val.trim().isNotEmpty) addNewCard(val.trim());
          },
        );
      },
    );
    ...
    await showDialog(
      ...
      builder: (_) {
        return _inputDialog(
          ...
          multiline: true,
          onConfirm: (val) {
            if (val.trim().isNotEmpty) updateCard(idx, val.trim());
          },
        );
      },
    );
    ...
    await showDialog(
      ...
      builder: (_) {
        return _inputDialog(
          ...
          onConfirm: (val) {
            if (val.trim().isNotEmpty) addNewCollection(val.trim());
          },
        );
      },
    );
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: hint,
                hintStyle: TextStyle(color: _P.muted, fontFamily: 'Georgia'),
                filled: true,
                fillColor: _P.card,
